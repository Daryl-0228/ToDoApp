...
export class TodosApi extends runtime.BaseAPI {
     ...
     * ToDoの削除
     */
    async deleteTodoRaw(requestParameters: DeleteTodoRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * ToDoの削除
     */
    async deleteTodo(requestParameters: DeleteTodoRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     * ToDo一覧の取得
     */
    async getTodosRaw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Array<Todo>>> {
        const queryParameters: any = {};
     ...
     * ToDo一覧の取得
     */
    async getTodos(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Array<Todo>> {
     ...
     * ToDoの登録
     */
    async postTodoRaw(requestParameters: PostTodoRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Todo>> {
     ...
     * ToDoの登録
     */
    async postTodo(requestParameters: PostTodoRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Todo> {
     ...
     * ToDoステータスの更新
     */
    async putTodoRaw(requestParameters: PutTodoRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Todo>> {
        if (requestParameters.todoId === null || requestParameters.todoId === undefined) {
     ...
     * ToDoステータスの更新
     */
    async putTodo(requestParameters: PutTodoRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Todo> {
